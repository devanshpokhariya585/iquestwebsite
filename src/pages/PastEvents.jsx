        ...
        {open && (
          ...
          >
            <motion.div
              ...
              style={{ background: 'linear-gradient(160deg, rgba(255,255,255,0.06), rgba(255,255,255,0.012)), #0d0406' }}
      ...
      <AnimatePresence>
        {lightbox && (
          <motion.div
            ...
            className="fixed inset-0 z-[90] flex items-center justify-center bg-void/[0.97] p-6 backdrop-blur-xl"
          >
            <motion.img
              ...
              src={lightbox}
              alt="Preview"
              className="max-h-[86vh] max-w-[92vw] rounded-2xl border border-white/15 object-contain shadow-[0_0_80px_rgba(255,35,56,0.25)]"
            />
            <button
              onClick={() => setLightbox(null)}
              aria-label="Close"
