...
function fill(i) {
  ...
  return (
    ...
    `linear-gradient(180deg,#160a1a,#0b0610)`
  )
}
  ...
  return (
    ...
    >
      <div className="relative h-full w-full transition-transform duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
        {/* FRONT — photo */}
        <div className="absolute inset-0 overflow-hidden rounded-2xl border border-white/12 bg-[#0d0712] shadow-lg [backface-visibility:hidden]">
