...
export const footer = {
  ...
  columns: [
    ...
    { title: 'Community', links: [
      ...
      { label: 'Code of Conduct', href: 'https://vit.ac.in/sites/default/files/Institutional-Policies/Student-Code-Conduct/index.html' },
      { label: 'Contact', href: 'https://chat.whatsapp.com/E0LIYdquaIaJ17PjS6RdR6?s=sw&p=a&mlu=4' },
    ] },
  ],
  socials: [
    {
      name: 'WhatsApp',
      href: 'https://chat.whatsapp.com/E0LIYdquaIaJ17PjS6RdR6?s=sw&p=a&mlu=4',
    },
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/iquest.vit?stkn=MTJidWNodmhqY2o0bA==',
    },
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/company/innovatorsquest/',
    },
  ],
...
export const pastEvents = [
  { id: 'p3', date: '2025-09-28', year: '2025', title: 'WANNA CRACK GSOC 2.0', tag: 'WORKSHOP', attendees: 150, blurb: '' },
