...
export const events = {
  ...
  list: [
    { id: 'g3', tag: 'WORKSHOP', title: 'Wanna Crack GSOC 3.0', date: 'SEP 18', time: '2:00 – 5:00 PM', location: 'Main Lab · Block C', status: 'REGISTERING' },
    { id: 'tos', tag: 'HACKATHON', title: 'Trails Of Secrets', date: 'SEP 19', time: '10:00 AM – 6:00 PM', location: 'Innovation Hub', status: 'REGISTERING' },
  ],
}
...
export const capabilities = {
  ...
  heading: 'THE STACK',
  subheading: 'Six circuits, one mission — turning ideas into shipped reality.',
  items: [
    { icon: 'Cpu', title: 'Technical', text: 'Building the future with code, hardware and systems.' },
    { icon: 'Zap', title: 'Electrical', text: 'Powering innovations through circuits and energy.' },
    { icon: 'Users', title: 'Management', text: 'Organizing people and resources to make things happen.' },
    { icon: 'Palette', title: 'Design', text: 'Crafting visuals and experiences that leave a mark.' },
    { icon: 'BookOpen', title: 'Editorial', text: 'Telling stories and sharing knowledge that matters.' },
    { icon: 'Video', title: 'Video Editing', text: 'Bringing ideas to life through motion and sound.' },
  ],
}
...
export const upcomingEvents = [
  { id: 'u1', date: '2025-09-27', title: 'Wanna Crack GSOC 2.0', tag: 'WORKSHOP', time: '2:00 – 5:00 PM', location: 'Main Lab · Block C' },
  { id: 'u2', date: '2026-02-07', title: 'CyberShieldX', tag: 'WORKSHOP', time: '10:00 AM – 4:00 PM', location: 'Innovation Hub' },
  { id: 'u3', date: '2026-03-05', title: 'SUSTAINATHON', tag: 'WORKSHOP', time: '11:00 AM – 5:00 PM', location: 'Innovation Hub' },
  { id: 'u4', date: '2026-09-18', title: 'Wanna Crack GSOC 3.0', tag: 'WORKSHOP', time: '2:00 – 5:00 PM', location: 'Main Lab · Block C' },
  { id: 'u5', date: '2026-09-19', title: 'Trails Of Secrets', tag: 'HACKATHON', time: '10:00 AM – 6:00 PM', location: 'Innovation Hub' },
]

//  Past events (recaps)
export const pastEvents = [
  { id: 'p1', date: '2025-09-27', year: '2025', title: 'Wanna Crack GSOC 2.0', tag: 'WORKSHOP', attendees: 140, blurb: '' },
  { id: 'p2', date: '2026-02-07', year: '2026', title: 'CyberShieldX', tag: 'WORKSHOP', attendees: 120, blurb: '' },
  { id: 'p3', date: '2026-03-05', year: '2026', title: 'SUSTAINATHON', tag: 'WORKSHOP', attendees: 150, blurb: '' },
]
